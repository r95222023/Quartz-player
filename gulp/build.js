...
gulp.task('presets', function () {
    return gulp.src(paths.src + '/app/presets/**/*')
        .pipe(gulp.dest(paths.dist + '/presets'));
});
...
gulp.task('buildapp', ['html', 'images', 'presets', 'core', 'fonts', 'translations', 'misc', 'data', 'examplejs']);
